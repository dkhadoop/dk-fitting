...
public class FormatRecService {
  ...
  public interface Iface {
     ...
     * @param hostPassword
     */
    public void formatRec(java.lang.String spStr, int fdSum, java.lang.String srcDirName, java.lang.String dstDirName, java.lang.String hostIp, java.lang.String hostPort, java.lang.String hostName, java.lang.String hostPassword) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void formatRec(java.lang.String spStr, int fdSum, java.lang.String srcDirName, java.lang.String dstDirName, java.lang.String hostIp, java.lang.String hostPort, java.lang.String hostName, java.lang.String hostPassword, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void formatRec(java.lang.String spStr, int fdSum, java.lang.String srcDirName, java.lang.String dstDirName, java.lang.String hostIp, java.lang.String hostPort, java.lang.String hostName, java.lang.String hostPassword) throws org.apache.thrift.TException
    {
      send_formatRec(spStr, fdSum, srcDirName, dstDirName, hostIp, hostPort, hostName, hostPassword);
      recv_formatRec();
    }

    public void send_formatRec(java.lang.String spStr, int fdSum, java.lang.String srcDirName, java.lang.String dstDirName, java.lang.String hostIp, java.lang.String hostPort, java.lang.String hostName, java.lang.String hostPassword) throws org.apache.thrift.TException
    {
      formatRec_args args = new formatRec_args();
      args.setSpStr(spStr);
      args.setFdSum(fdSum);
      ...
      sendBase("formatRec", args);
    }

    public void recv_formatRec() throws org.apache.thrift.TException
    {
      formatRec_result result = new formatRec_result();
      receiveBase(result, "formatRec");
      return;
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void formatRec(java.lang.String spStr, int fdSum, java.lang.String srcDirName, java.lang.String dstDirName, java.lang.String hostIp, java.lang.String hostPort, java.lang.String hostName, java.lang.String hostPassword, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      formatRec_call method_call = new formatRec_call(spStr, fdSum, srcDirName, dstDirName, hostIp, hostPort, hostName, hostPassword, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class formatRec_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("formatRec", org.apache.thrift.protocol.TMessageType.CALL, 0));
        formatRec_args args = new formatRec_args();
        args.setSpStr(spStr);
        args.setFdSum(fdSum);
        args.setSrcDirName(srcDirName);
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> java.util.Map<java.lang.String,  org.apache.thrift.ProcessFunction<I, ? extends org.apache.thrift.TBase>> getProcessMap(java.util.Map<java.lang.String, org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      processMap.put("formatRec", new formatRec());
      return processMap;
    }

    public static class formatRec<I extends Iface> extends org.apache.thrift.ProcessFunction<I, formatRec_args> {
      public formatRec() {
        super("formatRec");
      }

      public formatRec_args getEmptyArgsInstance() {
        return new formatRec_args();
      }
      ...
      public formatRec_result getResult(I iface, formatRec_args args) throws org.apache.thrift.TException {
        formatRec_result result = new formatRec_result();
        iface.formatRec(args.spStr, args.fdSum, args.srcDirName, args.dstDirName, args.hostIp, args.hostPort, args.hostName, args.hostPassword);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class formatRec<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, formatRec_args, Void> {
      public formatRec() {
        super("formatRec");
      }
      ...
      public void start(I iface, formatRec_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException {
        iface.formatRec(args.spStr, args.fdSum, args.srcDirName, args.dstDirName, args.hostIp, args.hostPort, args.hostName, args.hostPassword,resultHandler);
      }
    }

  }

  public static class formatRec_args implements org.apache.thrift.TBase<formatRec_args, formatRec_args._Fields>, java.io.Serializable, Cloneable, Comparable<formatRec_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("formatRec_args");
    ...
    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new formatRec_argsStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new formatRec_argsTupleSchemeFactory();
    ...
    static {
      ...
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(formatRec_args.class, metaDataMap);
    }

    public formatRec_args() {
    }
     ...
     */
    public formatRec_args(formatRec_args other) {
    ...
    public formatRec_args deepCopy() {
      return new formatRec_args(this);
    }
    ...
    public formatRec_args setSpStr(java.lang.String spStr) {
      this.spStr = spStr;
      return this;
    }
    ...
    public formatRec_args setFdSum(int fdSum) {
      this.fdSum = fdSum;
      setFdSumIsSet(true);
      return this;
    }
    ...
    public formatRec_args setSrcDirName(java.lang.String srcDirName) {
      this.srcDirName = srcDirName;
      return this;
    }
    ...
    public formatRec_args setDstDirName(java.lang.String dstDirName) {
      this.dstDirName = dstDirName;
      return this;
    }
    ...
    public formatRec_args setHostIp(java.lang.String hostIp) {
      this.hostIp = hostIp;
      return this;
    }
    ...
    public formatRec_args setHostPort(java.lang.String hostPort) {
      this.hostPort = hostPort;
      return this;
    }
    ...
    public formatRec_args setHostName(java.lang.String hostName) {
      this.hostName = hostName;
      return this;
    }
    ...
    public formatRec_args setHostPassword(java.lang.String hostPassword) {
      this.hostPassword = hostPassword;
      return this;
    }
    ...
    public boolean equals(java.lang.Object that) {
      if (that == null)
        return false;
      if (that instanceof formatRec_args)
        return this.equals((formatRec_args)that);
      return false;
    }

    public boolean equals(formatRec_args that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    public int compareTo(formatRec_args other) {
    ...
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("formatRec_args(");
      boolean first = true;
    ...
    private static class formatRec_argsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public formatRec_argsStandardScheme getScheme() {
        return new formatRec_argsStandardScheme();
      }
    }

    private static class formatRec_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<formatRec_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, formatRec_args struct) throws org.apache.thrift.TException {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, formatRec_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class formatRec_argsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public formatRec_argsTupleScheme getScheme() {
        return new formatRec_argsTupleScheme();
      }
    }

    private static class formatRec_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<formatRec_args> {

      
      public void write(org.apache.thrift.protocol.TProtocol prot, formatRec_args struct) throws org.apache.thrift.TException {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, formatRec_args struct) throws org.apache.thrift.TException {
  ...
  public static class formatRec_result implements org.apache.thrift.TBase<formatRec_result, formatRec_result._Fields>, java.io.Serializable, Cloneable, Comparable<formatRec_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("formatRec_result");


    private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new formatRec_resultStandardSchemeFactory();
    private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new formatRec_resultTupleSchemeFactory();
...
;
    ...
    static {
      java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(formatRec_result.class, metaDataMap);
    }

    public formatRec_result() {
    }

    /**
     * Performs a deep copy on <i>other</i>.
     */
    public formatRec_result(formatRec_result other) {
    }

    public formatRec_result deepCopy() {
      return new formatRec_result(this);
    }
    ...
    public boolean equals(java.lang.Object that) {
      if (that == null)
        return false;
      if (that instanceof formatRec_result)
        return this.equals((formatRec_result)that);
      return false;
    }

    public boolean equals(formatRec_result that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    public int compareTo(formatRec_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("formatRec_result(");
      boolean first = true;
    ...
    private static class formatRec_resultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public formatRec_resultStandardScheme getScheme() {
        return new formatRec_resultStandardScheme();
      }
    }

    private static class formatRec_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<formatRec_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, formatRec_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, formatRec_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class formatRec_resultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public formatRec_resultTupleScheme getScheme() {
        return new formatRec_resultTupleScheme();
      }
    }

    private static class formatRec_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<formatRec_result> {

      
      public void write(org.apache.thrift.protocol.TProtocol prot, formatRec_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      }

      
      public void read(org.apache.thrift.protocol.TProtocol prot, formatRec_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      }
    }
