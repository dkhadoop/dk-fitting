...
public class DKStreamProducerService {
  ...
  public interface Iface {
     ...
     */
    public void createTopic(String topicName, int partitions, int replicationFactor) throws org.apache.thrift.TException;
     ...
     * @param topicName
     */
    public void deleteTopic(String topicName) throws org.apache.thrift.TException;
     ...
     * @param topicName
     */
    public boolean topicIsExists(String topicName) throws org.apache.thrift.TException;

    /**
     * 查询所有topic，包括已经被标记删除，还没有删除的topic。
     * @return topic的list
     */
    public java.util.List<String> queryAllTopic() throws org.apache.thrift.TException;
     ...
     * @param message
     */
    public void streamDataToTopic(String topicName, String key, String message) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void createTopic(String topicName, int partitions, int replicationFactor, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void deleteTopic(String topicName, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;

    public void topicIsExists(String topicName, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws org.apache.thrift.TException;

    public void queryAllTopic(org.apache.thrift.async.AsyncMethodCallback<java.util.List<String>> resultHandler) throws org.apache.thrift.TException;

    public void streamDataToTopic(String topicName, String key, String message, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_createTopic(String topicName, int partitions, int replicationFactor) throws org.apache.thrift.TException
    {
    ...
    public void send_deleteTopic(String topicName) throws org.apache.thrift.TException
    {
    ...
    public void send_topicIsExists(String topicName) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<String> recv_queryAllTopic() throws org.apache.thrift.TException
    {
    ...
    public void send_streamDataToTopic(String topicName, String key, String message) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class createTopic_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public createTopic_call(String topicName, int partitions, int replicationFactor, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class deleteTopic_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      private String topicName;
      public deleteTopic_call(String topicName, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.topicName = topicName;
      }
    ...
    public static class topicIsExists_call extends org.apache.thrift.async.TAsyncMethodCall<Boolean> {
      private String topicName;
      public topicIsExists_call(String topicName, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.topicName = topicName;
      }
    ...
    public static class queryAllTopic_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<String>> {
      public queryAllTopic_call(org.apache.thrift.async.AsyncMethodCallback<java.util.List<String>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class topicIsExists<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, topicIsExists_args, Boolean> {
      public topicIsExists() {
        super("topicIsExists");
      }
      ...
      public void start(I iface, topicIsExists_args args, org.apache.thrift.async.AsyncMethodCallback<Boolean> resultHandler) throws org.apache.thrift.TException {
        iface.topicIsExists(args.topicName,resultHandler);
      }
    }

    public static class queryAllTopic<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, queryAllTopic_args, java.util.List<String>> {
      public queryAllTopic() {
        super("queryAllTopic");
      }
      ...
      public void start(I iface, queryAllTopic_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<String>> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class createTopic_args implements org.apache.thrift.TBase<createTopic_args, createTopic_args._Fields>, java.io.Serializable, Cloneable, Comparable<createTopic_args>   {
    ...
    public createTopic_args setTopicName(String topicName) {
      this.topicName = topicName;
      return this;
    }
    ...
    public int compareTo(createTopic_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetReplicationFactor()).compareTo(other.isSetReplicationFactor());
      if (lastComparison != 0) {
        return lastComparison;
      }
...
;
  ...
  public static class deleteTopic_args implements org.apache.thrift.TBase<deleteTopic_args, deleteTopic_args._Fields>, java.io.Serializable, Cloneable, Comparable<deleteTopic_args>   {
    ...
    public deleteTopic_args setTopicName(String topicName) {
      this.topicName = topicName;
      return this;
    }
...
;
  ...
  public static class topicIsExists_args implements org.apache.thrift.TBase<topicIsExists_args, topicIsExists_args._Fields>, java.io.Serializable, Cloneable, Comparable<topicIsExists_args>   {
    ...
    public topicIsExists_args setTopicName(String topicName) {
      this.topicName = topicName;
      return this;
    }
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("topicIsExists_args(");
      boolean first = true;
  ...
  public static class topicIsExists_result implements org.apache.thrift.TBase<topicIsExists_result, topicIsExists_result._Fields>, java.io.Serializable, Cloneable, Comparable<topicIsExists_result>   {
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("topicIsExists_result(");
      boolean first = true;
...
;
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("queryAllTopic_args(");
      boolean first = true;
  ...
  public static class queryAllTopic_result implements org.apache.thrift.TBase<queryAllTopic_result, queryAllTopic_result._Fields>, java.io.Serializable, Cloneable, Comparable<queryAllTopic_result>   {
    ...
    public queryAllTopic_result setSuccess(java.util.List<String> success) {
      this.success = success;
      return this;
    }
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("queryAllTopic_result(");
      boolean first = true;
  ...
  public static class streamDataToTopic_args implements org.apache.thrift.TBase<streamDataToTopic_args, streamDataToTopic_args._Fields>, java.io.Serializable, Cloneable, Comparable<streamDataToTopic_args>   {
    ...
    public streamDataToTopic_args setTopicName(String topicName) {
      this.topicName = topicName;
      return this;
    }
    ...
    public streamDataToTopic_args setKey(String key) {
      this.key = key;
      return this;
    }
    ...
    public streamDataToTopic_args setMessage(String message) {
      this.message = message;
      return this;
    }
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("streamDataToTopic_args(");
      boolean first = true;
...
;
    ...
    public String toString() {
      StringBuilder sb = new StringBuilder("streamDataToTopic_result(");
      boolean first = true;
