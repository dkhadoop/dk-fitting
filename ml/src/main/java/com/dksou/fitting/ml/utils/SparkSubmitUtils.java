...
public class SparkSubmitUtils {
     ...
     * @return   返回组拼好的命令。
     */
    public static String parameterAssembly(String masterUrl, Map<String,String> prop, DKMLConf dkmlConf, String className, String[] args) {
        ...
        command.append(">>" + " " + dkmlpath + "logs/dkml.log"  + " ");
