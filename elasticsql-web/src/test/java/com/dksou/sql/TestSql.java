...
public class TestSql {
    public static void main(String[] args) throws Exception {
        ...
        Connection connection = DriverManager.getConnection("jdbc:calcite:model=" +
                "F:\\dk\\es\\essql-5.6.8\\dk-essql-5.6.8\\src\\test\\java\\elasticsearch-zips-model2.json", info);
...
//        String sql = "SELECT count(prod_price),avg(prod_price),sum(prod_price),max(prod_price),min(prod_price) from Products ";
        ...
        String sql = "select item_price from orderitems";
...
//            System.out.println("resultSet = " + resultSet.getString(1));
            ...
            for (int i = 1; i <= columnCount; i++) {
                ...
                if (bt > 0) {
                    str2.append(columnName + "\t");
//                    System.out.println("columnName \t"+str2.toString());
                    bt--;
                }
//                System.out.println("columnName = " + columnName);
                Object value = resultSet.getObject(i);
//                System.out.print(i +" ==> columnName = " + columnName);
//                System.out.print("columnName = " + columnName);
//                System.out.println("    value = " + value);
//                System.out.println(columnName+"\t"+value);                //单列
                str.append(value + "\t");
            }
