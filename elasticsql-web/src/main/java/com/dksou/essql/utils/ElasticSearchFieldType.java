...
public enum ElasticSearchFieldType {
  ...
  private static final Map<String, ElasticSearchFieldType> MAP =
    new HashMap<String, ElasticSearchFieldType>();
  ...
  public static Map<String, ElasticSearchFieldType> getMap() {
    return MAP;
  }
}

// End ElasticSearchFieldType.java
